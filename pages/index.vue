<template>
  <main class="container">
    ...
    <sp-intro>
      ...
      I love keeping up to date in the latest and have an eager to always learn more. This website is built on Vue and served serverless. That means you can<pre>git pull</pre>it <a href="https://github.com/Knogobert/svenparker-nuxt" target="_blank">here</a> and run it completely local.
      <br/><small>
